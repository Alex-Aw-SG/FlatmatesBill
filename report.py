...
class PdfReport:
    """
    Creates PDF file that contains data about the flatmate such as
    ...
    def generate(self, flatmate1, flatmate2, bill):
        ...
        # webbrowser.open(self.filename) # for window
        webbrowser.open('file://' + os.path.realpath(self.filename)) # for mac/linux